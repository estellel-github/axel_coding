...
class SoftwareEngineer {
  ...
  displayEngineer() {
    console.log(
      `${this.name} is a ${this.seniority} software engineer. They work primarily with ${this.language}. They are based in ${this.location}.`
    );
  }
}
...
engineers.push(
  new SoftwareEngineer("Jane", "senior", "TypeScript", "San Francisco")
);
